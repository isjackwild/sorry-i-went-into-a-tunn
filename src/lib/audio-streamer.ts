...
export class AudioStreamer {
  ...
  public poorSignalWorklet?: AudioWorkletNode;
  ...
  constructor(public context: AudioContext) {
    ...
    (async () => {
      ...
      await this.context.audioWorklet.addModule(poorSignal);
      ...
      if (worklets) {
        Object.entries(worklets).forEach(([_workletName, graph]) => {
          ...
          if (node) {
            ...
            if (this.poorSignalWorklet) {
              node.connect(this.poorSignalWorklet);
            }
          }
        });
      }
